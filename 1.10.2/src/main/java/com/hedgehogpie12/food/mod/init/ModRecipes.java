 ...
 public class ModRecipes
 {
   ...
   {
     GameRegistry.addRecipe(new ItemStack(ModItems.carrot_soup), new Object[] { "CCC", "CCC", " B ", 'C', Items.CARROT, 'B', Items.BOWL });
     GameRegistry.addShapelessRecipe(new ItemStack(ModItems.filled_squid_meat), new ItemStack(Items.FLINT), new ItemStack(ModItems.raw_squid_meat));
     
     GameRegistry.addRecipe(new ItemStack(ModItems.potato_soup), new Object[] { "PPP", "PPP", " B ", 'P', Items.POTATO, 'B', Items.BOWL });
    //Horse 1
