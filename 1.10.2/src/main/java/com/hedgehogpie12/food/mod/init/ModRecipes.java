...
public class ModRecipes {
	public static void init() {
		...
		GameRegistry.addShapelessRecipe(new ItemStack(ModItems.filled_squid_meat), new ItemStack(Items.FLINT),
				new ItemStack(ModItems.raw_squid_meat));

		GameRegistry.addRecipe(new ItemStack(ModItems.potato_soup),
				new Object[] { "PPP", "PPP", " B ", 'P', Items.POTATO, 'B', Items.BOWL });
		// Horse 1
		GameRegistry.addSmelting(new ItemStack(ModItems.raw_horse_meat), new ItemStack(ModItems.cooked_horse_meat),
				0.35F);
		// Llama 2
		// GameRegistry.addSmelting(new ItemStack(ModItems.raw_llama_meat), new
		// ItemStack(ModItems.cooked_llama_meat), 0.35F);
		// Bat 3
		GameRegistry.addSmelting(new ItemStack(ModItems.raw_bat_meat), new ItemStack(ModItems.cooked_bat_meat), 0.35F);
		// Donkey 4
		// GameRegistry.addSmelting(new ItemStack(ModItems.raw_donkey_meat), new
		// ItemStack(ModItems.cooked_donkey_meat), 0.35F);
		// Mule 5
		// GameRegistry.addSmelting(new ItemStack(ModItems.raw_mule_meat), new
		// ItemStack(ModItems.cooked_mule_meat), 0.35F);
		// Squid 6
