...
public class ModItems {
	...
	/*
	 * NOT IN 1.11.2 only 1.12 and up!
	 * 
	 * public static Item raw_parrot_meat = new ModFood("raw_parrot_meat", 3,
	 * 1.8F, true); public static Item cooked_parrot_meat = new
	 * ModFood("cooked_parrot_meat", 8, 12.8F, true);
	 */
