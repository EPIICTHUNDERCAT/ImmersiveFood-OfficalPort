...
public class Reference {
	...
	public static final String MOD_NAME = "Immersive Food";
	public static final String VERSION = "1.11.2-0.0.2";
	public static final String ACCEPTEDVERSION = "[1.11,1.12)";

	public static final String CLIENT_PROXY = "com.hedgehogpie12.food.mod.proxy.ClientProxy";
	public static final String SERVER_PROXY = "com.hedgehogpie12.food.mod.proxy.CommonProxy";
